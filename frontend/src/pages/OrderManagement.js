...
function OrderManagement() {
    ...
    const getOrderByStatus = async (status) => {
        try {
            const res = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/order/${status}`, {
                headers: {
    ...
    const onSubmitCreateOrder = async e => {
        ...
        try {
            const res = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/order`, payload, 
            {
                headers: {
                    Authorization: `Bearer ${token}`,
                    'Access-Control-Allow-Origin': '*',
    ...
    const onSubmitUpdateStatus = async e => {
        ...
        try {
            const res = await axios.patch(`${process.env.REACT_APP_BACKEND_URL}/order`, payload, 
            {
                headers: {
                    Authorization: `Bearer ${token}`,
                    'Access-Control-Allow-Origin': '*',
