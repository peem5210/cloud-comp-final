...
const columns = [
    ...
    { id: 'customer_address', label: 'Address', minWidth: 225 },
    { id: 'detail', label: 'Detail', minWidth: 225 },
    { id: 'parcel_number', label: 'Parcel Number', minWidth: 150 },
    { id: 'shipping_time', label: 'Shipping Time', minWidth: 150 },
];
